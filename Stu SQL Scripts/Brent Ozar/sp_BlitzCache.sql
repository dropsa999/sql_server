...
<!-- saved from url=(0071)http://www.brentozar.com/first-aid/protected/?scripts/sp_BlitzCache.txt -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"></head><body data-pinterest-extension-installed="cr1.3.1"><pre style="word-wrap: break-word; white-space: pre-wrap;">USE master;
GO
